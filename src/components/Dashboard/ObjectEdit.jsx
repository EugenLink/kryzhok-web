...
export default function ObjectEdit({ item, back }) {
  ...
  const [personName, setPersonName] = useState(item.category.split(","));
    ...
    <div className={styles.dashWrapper}>
      ...
      <div className={styles.header}>
        <div className={styles.hRight}>
          <h1 className={styles.title}>Изменение объекта</h1>
        </div>
      </div>
      <div className={styles.hLeft}>
        <p style={{ cursor: "pointer" }} onClick={back}>
          {"<"} Назад
        </p>
      </div>
